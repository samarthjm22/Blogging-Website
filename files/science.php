...
$sql = "SELECT blog_id,blog_title,blog_desc,blog_category,blog_author,blog_is_active,creation_date,Name,img FROM blog_master WHERE blog_category='Science' order by creation_date Desc";

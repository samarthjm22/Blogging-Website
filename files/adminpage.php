...
<div class="welcome"><p>Welcome <?php echo $_SESSION['username']; ?>!</p></div>
  ...
  <ul class="top-menu">
    ...
    <li><a href="feedback.php">Feedback</a><div class="menu-item" id="about"></div></li>
   ...
   <div class="post-index z-depth-1">
		 ...
		 <?php
		      ...
		      "<i><b>Author: </i></b><a href='blogger.php?id=".$row['blog_author']."'>{$row['blog_author']}</a><br>".
		 		 ...
		 		 $image_name=$row['Name'];
		 			$image_path=$row['img'];
		 			echo "<img src=../".$image_name."/".$image_path." height=200 width=100%><br>";
		 		 echo "<br/>";
		 ...
		 ?>
		 <form name="block" action="block.php" enctype="multipart/form-data" method="post">
...
while($row =mysqli_fetch_assoc($result))
{
   ...
   <div class="post-index z-depth-1">
		 ...
		 ?>
		 <form name="block" action="unblock.php" enctype="multipart/form-data" method="post">
		 <input type="hidden" name="id" value="<?php echo $row['blog_id'];?>">
